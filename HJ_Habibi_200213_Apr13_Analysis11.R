...
## samples
xtabs(~ oExp.lumi$Symptoms + oExp.lumi$Day)
...
table(dfSamples[ , 'Symptoms'], dfSamples[  , 'Day'])
...
i1 = grepl('^1$|^3$', dfSamples$Day) & grepl('^Uninfected$', x = dfSamples$Symptoms)
table(dfSamples[(i1), 'Symptoms'], dfSamples[(i1), 'Day'])
i2 = grepl('^5$', dfSamples$Day) & grepl('^Uninfected$', x = dfSamples$Symptoms)
table(dfSamples[(i2), 'Symptoms'], dfSamples[(i2), 'Day'])
i3 = grepl('^7$|^10$', dfSamples$Day) & grepl('^Uninfected$', x = dfSamples$Symptoms)
table(dfSamples[(i3), 'Symptoms'], dfSamples[(i3), 'Day'])
i4 = grepl('^28$', dfSamples$Day) & grepl('^Uninfected$', x = dfSamples$Symptoms)
table(dfSamples[(i4), 'Symptoms'], dfSamples[(i4), 'Day'])
...
i1 = grepl('^1$|^3$', dfSamples$Day) & grepl('^Clinical cold$', x = dfSamples$Symptoms)
table(dfSamples[(i1), 'Symptoms'], dfSamples[(i1), 'Day'])
i2 = grepl('^5$', dfSamples$Day) & grepl('^Clinical cold$', x = dfSamples$Symptoms)
table(dfSamples[(i2), 'Symptoms'], dfSamples[(i2), 'Day'])
i3 = grepl('^7$|^10$', dfSamples$Day) & grepl('^Clinical cold$', x = dfSamples$Symptoms)
table(dfSamples[(i3), 'Symptoms'], dfSamples[(i3), 'Day'])
i4 = grepl('^28$', dfSamples$Day) & grepl('^Clinical cold$', x = dfSamples$Symptoms)
table(dfSamples[(i4), 'Symptoms'], dfSamples[(i4), 'Day'])
...
fSamples = factor(fSamples, levels=c('D0', 'UI1.3', 'UI5', 'UI7.10', 'UI28', 'C1.3', 'C5', 'C7.10', 'C28'))
levels(fSamples)
table(fSamples)
...
for (i in seq_along(n)) {
  ...
  f = paste('Results/', 'Significant_genes_at_10pcFDR_joint', names(n[i]), '.csv', sep='')
