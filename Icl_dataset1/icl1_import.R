...
df = data.frame(3, 7, dfSample$PID, dfSample$samplesNum, 
...
n = make.names('oLumiExpressionSet for RSV ICL April 2013 rds')
df = data.frame(7, n, '.rds', '~/Data/MetaData/', 'RSV Dataset Illumina microarray Sample from Imperial College London for infected symptomatic and asymptomatic at particular days, covariates: timepoint, infection status, symptoms')
colnames(df) = cn
n2 = paste0('Objects/', n)
