# File: HJ_Habibi_200213_Apr13_No_Symptoms.R
# Desc: Data set from RSV challenge - using symptoms as factor
...
fSamples = as.factor(oExp.lumi$Symptoms)
fSamples = factor(as.character(fSamples), levels = c('Uninfected no cold', 'Infected no cold', 'Infected cold'), 
                  labels = c('UINC', 'INC', 'IC') )
