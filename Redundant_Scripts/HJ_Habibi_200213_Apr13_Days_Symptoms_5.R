# File: HJ_Habibi_200213_Apr13_Days_Symptoms_5.R
...
# sanity check
table(dfSamples[i & (i1 | i2 | i3 | i4), 'Symptoms'], dfSamples[i & (i1| i2 | i3 | i4), 'Day'])
fSamples[i & i1] = paste0('NoCold', '0.1')
...
fSamples = factor(fSamples, levels = c('UINC', 'NoCold0.1', 'NoCold3.5', 'NoCold7.10', 'NoCold28', 
                                      'Cold0.1', 'Cold3.5', 'Cold7.10', 'Cold28'))
table(fSamples)
