# File: HJ_Habibi_200213_Apr13_Days_Symptoms_2.R
...
i = grepl('^Infected cold$', x = oExp.lumi$Symptoms)
...
fSamples = factor(fSamples, levels = c('UINC', 'NoCold3.5', 'NoCold7.10', 'NoCold28', 'Cold3.5', 'Cold7.10', 'Cold28'))
table(fSamples)
