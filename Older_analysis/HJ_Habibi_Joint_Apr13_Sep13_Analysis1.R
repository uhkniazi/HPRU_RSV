# File: HJ_Habibi_Joint_Apr13_Sep13_Analysis1.R
...
# sanity check
head(data.frame(fSamples, dfSamples$day))
fSamples = factor(fSamples, levels=c('D0', 'D1', 'D3', 'D5', 'D7', 'D10', 'D14', 'D28'))
levels(fSamples)
table(fSamples)
####### end grouping
